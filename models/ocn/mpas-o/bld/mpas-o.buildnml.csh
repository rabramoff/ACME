...
if ( $OCN_GRID == 'oEC60to30' ) then
	set input_mesh = $DIN_LOC_ROOT/ocn/mpas-o/$OCN_GRID/ocean.EC.60-30km.nc
	set graph_prefix = $DIN_LOC_ROOT/ocn/mpas-o/$OCN_GRID/mpas-o.graph.info
else if ( $OCN_GRID == 'mpas120' ) then
	set input_mesh = $DIN_LOC_ROOT/ocn/mpas-o/$OCN_GRID/ocean120km.nc
	set graph_prefix = $DIN_LOC_ROOT/ocn/mpas-o/$OCN_GRID/mpas-o.graph.info
endif
