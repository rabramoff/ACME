...
!  call this%sumup_cnp_mass('af run_decomp')
  ...
  write(*,*)'o2_decomp_depth',  o2_decomp_depth
...
write(*,*)'summs_forc%ystates(:)',summs_forc%ystates(:)
...
write(*,*)'this%ystates1(kc)',this%ystates1(kc) !RZA
write(*,*)'this%ystates0(kc)',this%ystates0(kc)
write(*,*)'summs_forc%cflx_input_litr_met*dtime/catomw',summs_forc%cflx_input_litr_met*dtime/catomw
write(*,*)'summs_forc%cflx_input_litr_met',summs_forc%cflx_input_litr_met
write(*,*)'dtime/catomw',dtime/catomw
write(*,*)'dtime',dtime
write(*,*)'catomw',catomw
